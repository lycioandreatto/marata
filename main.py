...
def carregar_dados():
    try:
        ...
        for df in [df_b, df_a]:
            cols_cod = [c for c in df.columns if 'Cliente' in c or 'CÓDIGO' in c or 'CLIENTE' in c]
            for col in cols_cod:
...
# Quem tem poder de ver tudo
tem_acesso_total = is_admin or is_diretoria or is_analista

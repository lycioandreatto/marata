...
# --- PÁGINA: VER/EDITAR ---
    ...
    if df_agenda is not None and not df_agenda.empty:
        ...
        if not linhas_marcadas.empty:
            ...
            # 1. Seletores Fora do Form (para a caixa "Outro" ser dinâmica)
            ...
            with col_dir:
                ...
                motivo_outro = ""
                if n_ju == "OUTRO":
                    motivo_outro = st.text_input("Especifique o motivo:", placeholder="Escreva aqui...")

            # 2. Formulário apenas para os botões de ação

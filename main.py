...
NOME_ADMIN = "LYCIO"
LISTA_ANALISTA = ["BÁRBARA COSTA","THAIS OLIVEIRA","ROBERIO","CAROL","REGIANE","ALLANA ANDRADE", "COSME DANILO", "KAIO GOMES", "KAIO SOUZA"]
NOME_DIRETORIA = "ALDO"
...
LISTA_ANALISTA = ["BÁRBARA COSTA", "THAIS OLIVEIRA","ALLANA ANDRADE","Roberio","Regiane","Carol"] 

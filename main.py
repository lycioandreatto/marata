           ...
           df_dia["EDITAR"] = False
            ...
            if not marcados.empty:
                ...
                if st.button("💾 ATUALIZAR STATUS"):
                    ...
                    # SALVAMENTO NA PLANILHA (Incluindo a nova coluna DISTANCIA_LOG)
                    # Certifique-se de que a coluna DISTANCIA_LOG existe no seu Google Sheets
                    ...
                    st.cache_data.clear()
                    if alerta_distancia:
                        # Aviso genérico para o supervisor
